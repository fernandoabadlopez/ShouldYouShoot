# XR Interaction Toolkit Examples - Version 3.4.0
...
1. Open a project in Unity
    ...
    1. In the **Installs** tab, select **Locate** or **Add** to find or install Unity 6000.3 LTS or later. Include the **Windows Build Support (IL2CPP)** module if building for PC, and the **Android Build Support** if building for Android (for example, Meta Quest).
